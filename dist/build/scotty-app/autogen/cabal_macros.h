...
/* package scotty-app-0.1.0.0 */
#ifndef VERSION_scotty_app
#define VERSION_scotty_app "0.1.0.0"
#endif /* VERSION_scotty_app */
#ifndef MIN_VERSION_scotty_app
#define MIN_VERSION_scotty_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_scotty_app */
...
#define CURRENT_COMPONENT_ID "scotty-app-0.1.0.0-Dn6GaP0mnPo35DSbPAfEcx-scotty-app"
